ว# Coffee Shop Management System
...
* ระบบชำระเงิน (Cash / QR Code) (อยู่ระหว่างดำเนินการ)
...
---
### User Flow: ระบบร้านกาแฟ (Coffee Shop Management System)
1. สำหรับลูกค้า (Customer Flow)
• เข้าสู่ระบบ/สมัครสมาชิก: ลูกค้าทำการ Login หรือ Register เพื่อสะสมแต้ม
• เลือกเมนู: ดูรายการเครื่องดื่มและขนมที่มีอยู่ในร้าน
• สั่งซื้อ: เลือกสินค้าลงตะกร้าและยืนยันคำสั่งซื้อ (Order)
• ชำระเงิน: เลือกวิธีการชำระเงิน ระบบจะคำนวณแต้มสะสมให้โดยอัตโนมัติ
2. สำหรับบาริสต้า (Barista Flow)
• รับออเดอร์: ดูรายการคำสั่งซื้อที่เข้ามาใหม่ในหน้า Barista Dashboard
• ดำเนินการชง: เปลี่ยนสถานะออเดอร์เป็น "กำลังทำ"
• เสร็จสิ้นและตัดสต็อก: เมื่อกด "ชงเสร็จ" ระบบจะตัดสต็อกวัตถุดิบตามสูตรที่ตั้งไว้โดยอัตโนมัติ
3. สำหรับผู้จัดการ/เจ้าของร้าน (Admin Flow)
• จัดการเมนู: สามารถเพิ่มเมนูใหม่ หรือลบเมนูที่ไม่ต้องการออกได้
• จัดการสต็อก: ตรวจสอบจำนวนวัตถุดิบที่เหลือและทำการเติมสต็อก (Refill)
• ดูรายงาน: ตรวจสอบยอดขายรวมและอันดับสินค้าขายดีเพื่อวิเคราะห์กำไร
...
## 3.4 UX/UI
### DESIGN:https://crane-words-49597245.figma.site/
### ระบบหน้าร้าน
...
การทดสอบหลังพัฒนาเปรียบเทียบกับSRS:[Test Case.pdf](https://github.com/user-attachments/files/26296865/Test.Case.pdf)
